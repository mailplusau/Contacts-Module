    ...
    function (ui, email, runtime, search, record, https, log, redirect, url, format, task) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method === 'GET') {
                ...
                if (role == 3 || role == 1032) {
                    inlineHtml += '<div class="container instruction_div hide" style="background-color: lightblue;font-size: 14px;padding: 15px;border-radius: 10px;border: 1px solid;box-shadow: 0px 1px 26px -10px white;"><p><b><u>Action Buttons</u></b><ol><li><b>CREATE PASSWORD EMAIL SENT</b>: Click button when create password email has been sent to the contact.</li><li><b>ACCOUNT ACTIVATED</b>: Click button when the contact has created the password and account has been activated. </li><li><b>RESEND</b>: Click button to resend the Create Password email. </li></ol></p><p><b><u>USAGE SOURCE STATUS</u></b> <i style="color: #ff9090;font-weight: bold;">(Based on contact created date)</i><ol><li><b>EMPTY</b>: No Account has been created.</li><li><b>NO USAGE</b>: No usage from the time the contact has been created.</li><li><b>DIGITAL LABEL</b>: Manual Barcodes have not been used from the time the contact has been created. </li><li><b>MANUAL BARCODES</b>: Manual Barcodes have been used from the time the contact has been created. </li></ol></p></div></br>'
                } else {
